...
class NaverMapView extends GetView<NaverMapViewController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      controller.searchLocation.value = context.watch<SearchBloc>().startLocation;
      controller.destinationLocation.value = context.watch<SearchBloc>().destinationLocation;
