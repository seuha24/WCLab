...
const List<String> labelsClock = [
  '12시 방향','1시 방향','2시 방향','3시 방향','4시 방향','5시 방향',
  '6시 방향','7시 방향','8시 방향','9시 방향','10시 방향','11시 방향',
];
const List<String> labelsCounterClock = [
  '12시 방향','11시 방향','10시 방향','9시 방향','8시 방향','7시 방향',
  '6시 방향','5시 방향','4시 방향','3시 방향','2시 방향','1시 방향',
];
...
class GuidanceCalculator {
  ...
  String getGuidanceDirection(
    ...
    double deviationYawTurn, double bearingToPoint,
  ) {
    ...
    double guidanceAngle = Calculators.angleToTarget(
      currentIndexLongitude, currentIndexLatitude,
      targetIndexLongitude, targetIndexLatitude,
      currentLatitude, currentLongitude,
      deviationYawTurn, bearingToPoint, boundaryExit,
    );
    ...
    final directionLabels = (boundaryExit > 0) ? labelsCounterClock : labelsClock;
  ...
  BoundaryEvalResult evaluateBoundary({
    ...
    for (int i = 0; i < window.length - 1; i++) {
      ...
      final linear = Calculators.pointLineDistance(
              cur.point.latitude, cur.point.longitude,
